...
heights_df <- read.csv("/Users/sarah/hello_world/data/r4ds/heights.csv")
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point() + ggtitle('Height vs. Earnings') + ylab('Dollars') + xlab('Inches') 
