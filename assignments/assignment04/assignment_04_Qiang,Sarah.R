...
setwd("/Users/sarah/documents/hello_world/assignments/assignment04")
...
## Load the file `"/Users/sarah/documents/hello_world/data/nytimes/covid-19-data/us-states.csv"` and
